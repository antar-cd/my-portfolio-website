...
const Contact = () => {
    const contact_info=[
        {logo:'mail',text:'antumojumder15@gmail.com'},
        {logo:'logo-whatsapp',text:'01533-933222'},
            ...
            <div className='text-center mt-8'>
                ...
                <div className='mt-16 flex md:flex-row flex-col gap-6 max-w-5xl bg-gray-800 md:p-6 p-2 rounded-lg mx-auto'>
                    <form className='flex flex-col flex-1 gap-5'>
                        ...
                        <textarea placeholder='Your Messege' rows={10}></textarea>
                        <button className='btn-primary w-fit'>Send Messege</button>
                    </form>
